    ...
    t.cleanData = function (e) {
        ...
        function () {
            ...
            t.position = {
                    ...
                    s = t.extend({}, s);
                    var f, p, v, g, b, _, y = t(s.of),
                        w = t.position.getWithinInfo(s.within),
                        x = t.position.getScrollInfo(w),
                        C = (s.collision || "flip").split(" "),
                        T = {};
                    return _ = n(y), y[0].preventDefault && (s.at = "left top"), p = _.width, v = _.height, g = _.offset, b = t.extend({}, g), t.each(["my", "at"], function () {
                        var t, e, i = (s[this] || "").split(" ");
                        1 === i.length && (i = l.test(i[0]) ? i.concat(["center"]) : h.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = l.test(i[0]) ? i[0] : "center", i[1] = h.test(i[1]) ? i[1] : "center", t = c.exec(i[0]), e = c.exec(i[1]), T[this] = [t ? t[0] : 0, e ? e[0] : 0], s[this] = [d.exec(i[0])[0], d.exec(i[1])[0]]
                    }), 1 === C.length && (C[1] = C[0]), "right" === s.at[0] ? b.left += p : "center" === s.at[0] && (b.left += p / 2), "bottom" === s.at[1] ? b.top += v : "center" === s.at[1] && (b.top += v / 2), f = e(T.at, p, v), b.left += f[0], b.top += f[1], this.each(function () {
                        var n, l, h = t(this),
                            c = h.outerWidth(),
                            d = h.outerHeight(),
                            m = i(this, "marginLeft"),
                            ...
                            E = d + _ + i(this, "marginBottom") + x.height,
                            W = t.extend({}, b),
                            I = e(T.my, h.outerWidth(), h.outerHeight());
                        "right" === s.my[0] ? W.left -= c : "center" === s.my[0] && (W.left -= c / 2), "bottom" === s.my[1] ? W.top -= d : "center" === s.my[1] && (W.top -= d / 2), W.left += I[0], W.top += I[1], o || (W.left = u(W.left), W.top = u(W.top)), n = {
                            marginLeft: m,
                            marginTop: _
                            ...
                            c > p && p > r(e + i) && (u.horizontal = "center"), d > v && v > r(n + o) && (u.vertical = "middle"), u.important = a(r(e), r(i)) > a(r(n), r(o)) ? "horizontal" : "vertical", s.using.call(this, t, u)
                        }), h.offset(t.extend(W, {
                            using: l
                        }))
                    })
                    ...
                    fit: {
                        left: function (t, e) {
                            ...
                            e.collisionWidth > o ? u > 0 && 0 >= l ? (i = t.left + u + e.collisionWidth - o - s, t.left += u - i) : t.left = l > 0 && 0 >= u ? s : u > l ? s + o - e.collisionWidth : s : u > 0 ? t.left += u : l > 0 ? t.left -= l : t.left = a(t.left - r, t.left)
                        },
                        top: function (t, e) {
                            var i, n = e.within,
                            ...
                            e.collisionHeight > o ? u > 0 && 0 >= l ? (i = t.top + u + e.collisionHeight - o - s, t.top += u - i) : t.top = l > 0 && 0 >= u ? s : u > l ? s + o - e.collisionHeight : s : u > 0 ? t.top += u : l > 0 ? t.top -= l : t.top = a(t.top - r, t.top)
                        }
                    },
                    flip: {
                        left: function (t, e) {
                            var i, n, s = e.within,
                                ...
                                m = -2 * e.offset[0];
                            0 > h ? (i = t.left + d + f + m + e.collisionWidth - a - o, (0 > i || r(h) > i) && (t.left += d + f + m)) : c > 0 && (n = t.left - e.collisionPosition.marginLeft + d + f + m - u, (n > 0 || c > r(n)) && (t.left += d + f + m))
                        },
                        top: function (t, e) {
                            var i, n, s = e.within,
                                ...
                                p = -2 * e.offset[1];
                            0 > h ? (n = t.top + f + m + p + e.collisionHeight - a - o, (0 > n || r(h) > n) && (t.top += f + m + p)) : c > 0 && (i = t.top - e.collisionPosition.marginTop + f + m + p - u, (i > 0 || c > r(i)) && (t.top += f + m + p))
                        }
                    },
                    flipfit: {
                        left: function () {
            ...
            _create: function () {
                ...
                this.isMultiLine = o ? !0 : a ? !1 : this.element.prop("isContentEditable"), this.valueMethod = this.element[o || a ? "val" : "text"], this.isNewMenu = !0, this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off"), this._on(this.element, {
                    ...
                    menufocus: function (e, i) {
                        ...
                        }), void 0) : (s = i.item.data("ui-autocomplete-item"), !1 !== this._trigger("focus", e, {
                            item: s
                        }) && e.originalEvent && /^key/.test(e.originalEvent.type) && this._value(s.value), n = i.item.attr("aria-label") || s.value, n && t.trim(n).length && (this.liveRegion.children().hide(), t("<div>").text(n).appendTo(this.liveRegion)), void 0)
                    },
